...
EnumMap<StatusPedido, Integer> contagem = new EnumMap<>(StatusPedido.class);` },
        ...
        { p: 'Enums são singletons garantidos pela JVM e podem ser comparados com `==` com segurança — inclusive é o jeito preferido, porque funciona com `null` sem lançar NPE.' },
      ],
      passos: [],
    },
  ],
